...
![Version: 1.5.7](https://img.shields.io/badge/Version-1.5.7-informational?style=flat-square)
...
| startupProbe.httpGet.path | string | `"/healthcheck"` | the path for liveness check |
